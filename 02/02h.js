...
if(command === "sum"){
    ...
    let obj = {name :numbers[0],family:numbers[1],gmail: numbers[2] }
    fs.writeFile("./data.txt" , JSON.stringify(obj),readCallBack)
} 
else if(command === "create"){
    fs.readFile("file.json", readCallBack)
} 
else{
    console.log("ERR")
}
...
function readCallBack(Err , Data){
    ...
    else
    {
        ...
        newObj.user.push(obj)
        fs.writeFile("./file.json",JSON.stringify(newObj),writeCallBack) 
    }
}
